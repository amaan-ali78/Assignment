    ...
    <div className="p-4">
      ...
      <div className="flex justify-between mt-4">
        <button
          ...
          className={`px-4 py-2 bg-zinc-400 text-white rounded ${page === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
          Previous
        </button>
        <button
          ...
          disabled={!nextPage}
          className={`px-4 py-2 bg-zinc-400 text-white rounded ${!nextPage ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
          Next
        </button>
      </div>
